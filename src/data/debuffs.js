...
export const DEBUFFS = {
  ...
  legacyOfSin: {
    key: 'legacyOfSin', label: 'Legacy of Sin', icon: 'unholy', color: '#5e35b1',
    tags: [TAG.affliction, TAG.curse], amplify: 'damageTaken',
    ampTypes: {}, per: 0, cap: 0, stackCap: 1, dur: [20, 30],
    elements: ['shadow'], levers: ['absolve', 'fate'],
    blurb: 'marking what the target has already answered for',
  },
  markOfSin: {
