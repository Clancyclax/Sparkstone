...
**ROUND 102 — ACTS 2, 3 AND 4 ARE BUILT.** The chain is twenty-four stages over
four acts, walked end to end in the build by `tools/tests/test_round102.cjs`.
Act 3 is the Elehyd reduction site (the user's ruling: "a quintessence harvest in
the badlands") behind a Gold-rank gate the Pirate Queen holds; Act 4 is the royal
warrant, the four noble houses, a council vote that can be lost, the western
base, Rory in two phases, the child, and seven gods on the road home with Liberty
silent. Act 2's last stage, `div2_close`, had been unfinishable since round 76 —
see ROUND102_NOTES.md.

**Still not built after round 102:** the companions have no story beats of their
own, and the story stops where DESIGN_STORY does — the seven offers stand
unanswered.

*(Superseded, kept for the record — this was true through round 101:)*
